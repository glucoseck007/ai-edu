          ...
          return (
            <Row className="py-4" key={index}>
              <Col md={6} className="border-end">
                <p className="text-dark">{value.Question}</p>
              </Col>
                      ...
                      >
                        ...
                        {isConfused &&
                          (selectedConfused.includes(index) ? (
                            ...
                            <div
                              className={`d-flex align-items-center justify-content-center rounded-circle bg-white text-dark border border-2 border-black position-relative ${
                                isConfused ? "slashed" : ""
                              }`}
                              style={{
                                width: "30px",
